...
def test_urdf_xacro():
    # General Arguments
    description_package = "piklet_description"
    description_file = "piklet_robot.urdf.xacro"

    description_file_path = os.path.join(
        get_package_share_directory(description_package), "urdf", "piklet_m1",  description_file
    )
